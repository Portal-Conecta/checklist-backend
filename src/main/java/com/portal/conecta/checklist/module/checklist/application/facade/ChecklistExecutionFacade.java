...
private final SubmitChecklistExecutionUseCase submitChecklistExecutionUseCase;
    ...
    public  ChecklistExecutionResponseDTO submitDTO(UUID executionId, ChecklistExecutionSubmitDTO submitDTO){
ChecklistExecution execution = submitChecklistExecutionUseCase.execute(executionId,submitDTO);
return executionMapper.toResponse(execution);
    }
