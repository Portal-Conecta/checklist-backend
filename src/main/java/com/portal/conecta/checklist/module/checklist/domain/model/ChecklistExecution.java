 ...
 * pontuação de conformidade e dados de contexto como sala, turma, usuário e
 * período da execução. Pendências (issues) geradas pela execução pertencem ao
 * módulo Issues (ver ADR-0020) e são consultadas via porta, não como coleção
 * desta entidade.
 * </p>
 *
 * <p>
