 ...
 * value}) consumido pelo Chart.js. Vive na camada application (assim como o
 * StatsEntryDTO), portanto o use case pode retorna-lo sem violar a regra de
 * arquitetura "application nao depende de presentation".</p>
 */
