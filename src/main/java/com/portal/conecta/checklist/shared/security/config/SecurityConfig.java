 ...
 * <li>Rotas públicas: {@code GET /actuator/health} e
 * {@code GET /actuator/info}.
 * Swagger liberado condicionalmente via
 * {@code checklist.security.swagger-public=true}.</li>
 * <li>As demais rotas exigem autenticação.</li>
 * <li>{@link HubJwtAuthenticationFilter} inserido antes do filtro padrão do
 * Spring Security.</li>
 * <li>Respostas padronizadas para {@code 401 Unauthorized} e
 * {@code 403 Forbidden}
 * via {@link SecurityErrorResponseWriter}.</li>
 * </ul>
 *
 * <p>
 * O bean do {@link HubJwtAuthenticationFilter} é desregistrado do servlet
 * container
 * para evitar dupla execução — é gerenciado exclusivamente pelo Spring
 * Security.
 * </p>
 */
@Configuration
...
public class SecurityConfig {
        ...
        public FilterRegistrationBean<HubJwtAuthenticationFilter> hubJwtAuthenticationFilterRegistration() {
                FilterRegistrationBean<HubJwtAuthenticationFilter> registration = new FilterRegistrationBean<>(
                                hubJwtAuthenticationFilter);
                ...
                return http
                                ...
                                .exceptionHandling(exception -> exception
                                                .authenticationEntryPoint((request, response,
                                                                authException) -> securityErrorResponseWriter.write(
                                                                                request,
                                                                                response,
                                                                                HttpStatus.UNAUTHORIZED,
                                                                                "Token de autenticacao e obrigatorio."))
                                                .accessDeniedHandler((request, response,
                                                                accessDeniedException) -> securityErrorResponseWriter
                                                                                .write(
                                                                                                request,
                                                                                                response,
                                ...
                                .authorizeHttpRequests(authorize -> {
                                        authorize.requestMatchers(HttpMethod.GET, "/actuator/health", "/actuator/info")
                                                        .permitAll();
