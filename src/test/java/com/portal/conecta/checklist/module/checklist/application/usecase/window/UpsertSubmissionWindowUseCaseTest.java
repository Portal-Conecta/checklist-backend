...
class UpsertSubmissionWindowUseCaseTest {
    ...
    void deveAtualizarJanelaExistenteQuandoUsuarioWegInformaCombinacaoJaCadastrada() {
        ...
        ChecklistSubmissionWindow existing = ChecklistSubmissionWindow.builder()
                ...
                .durationMinutes(30)
                .build();
        SubmissionWindowRequestDTO request = new SubmissionWindowRequestDTO(LocalTime.of(18, 0), 45);
    ...
    void devePermitirHorariosDiferentesParaTurmasDistintasDoMesmoTipo() {
        ...
        SubmissionWindowRequestDTO morningRequest = new SubmissionWindowRequestDTO(LocalTime.of(7, 30), 30);
        SubmissionWindowRequestDTO afternoonRequest = new SubmissionWindowRequestDTO(LocalTime.of(14, 45), 25);
    ...
    void deveRejeitarJanelaQueUltrapassaMeiaNoite() {
        UUID classId = UUID.randomUUID();
        SubmissionWindowRequestDTO request = new SubmissionWindowRequestDTO(LocalTime.of(23, 45), 30);
