...
class ResolveIssueUseCaseTest {

    private final ChecklistIssueRepositoryPort repository = mock(ChecklistIssueRepositoryPort.class);
    private final RequestContextProvider contextProvider = mock(RequestContextProvider.class);
    private final ResolveIssueUseCase useCase = new ResolveIssueUseCase(repository, contextProvider);

    @Test
    void shouldAllowWegOrSenaiToResolveIssue() {
    ...
    void shouldRejectInvalidTransition() {
        ...
        ChecklistIssue issue = ChecklistIssue.builder()
                .id(issueId)
                .status(IssueStatus.OPEN) // OPEN -> RESOLVED directly is rejected
                .build();
