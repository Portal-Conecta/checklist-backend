package com.portal.conecta.checklist.module.issues.application.usecase.command.start;
...
class StartIssueProgressUseCaseTest {

    private final ChecklistIssueRepositoryPort repository = mock(ChecklistIssueRepositoryPort.class);
    private final RequestContextProvider contextProvider = mock(RequestContextProvider.class);
    private final StartIssueProgressUseCase useCase = new StartIssueProgressUseCase(repository, contextProvider);

    @Test
    void shouldAllowWegOrSenaiToStartIssueProgress() {
