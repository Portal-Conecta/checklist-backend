...
class UpsertSubmissionWindowUseCaseTest {
        ...
        void deveCriarJanelaQuandoUsuarioSenaiInformaCombinacaoNova() {
                ...
                when(hubClassProvider.findById(classId))
                                .thenReturn(Optional.of(classReference(classId, Shift.FULL_AM_PM)));
                when(repository.findByClassIdAndChecklistType(classId, ChecklistType.ARRIVAL))
                                .thenReturn(Optional.empty());
                when(repository.save(any(ChecklistSubmissionWindow.class)))
        ...
        void deveAtualizarJanelaExistenteQuandoUsuarioWegInformaCombinacaoJaCadastrada() {
                ...
                when(hubClassProvider.findById(classId))
                                .thenReturn(Optional.of(classReference(classId, Shift.FULL_PM_NT)));
        ...
        void devePermitirHorariosDiferentesParaTurmasDistintasDoMesmoTipo() {
                ...
                UpsertSubmissionWindowCommand morningRequest = new UpsertSubmissionWindowCommand(LocalTime.of(7, 30),
                                30);
                UpsertSubmissionWindowCommand afternoonRequest = new UpsertSubmissionWindowCommand(LocalTime.of(14, 45),
                                25);
                ...
                ChecklistSubmissionWindow morningWindow = useCase.execute(morningClassId, ChecklistType.ARRIVAL,
                                morningRequest);
                ChecklistSubmissionWindow afternoonWindow = useCase.execute(afternoonClassId, ChecklistType.ARRIVAL,
                                afternoonRequest);
